...
<template>
  <main>
    ...
    <div class="flex content-between space-x-32 pb-8">
        <div class="w-2/4">
            <h2 class="font-nunito-sans text-xl text-blanc-text  pb-6 pt-10">Noffta supports you in the creation of NFT</h2>
            <p class="text-blanc-text font-lato text-lg w-4/5 ">Indeed, you will be able to design, modify, sign, publish and even
      ...
      <div class="px-36">
        ...
        <p class="text-white w-96 pb-20">Our project is linked to the OFFF Festival in Barcelona. We are setting up an NFT generator accessible to festival 
        ...
        <div class="px-36">
          ...
          <p class="text-white">FAQ à faire ici</p>


          <div>

            <div class="bg-newsletter bg-no-repeat pb-96 pt-32"  alt="formulaire de la newsletter">
              <h2 class="font-nunito-sans text-lg  text-blanc-text pb-10 text-center pt-32"> Subscribe to our newsletter</h2>
              <form action="#">
                      <div class="items-center mx-auto mb-3 space-y-4 max-w-sm sm:flex sm:space-y-0">
                          <div class=" w-96 mx-auto">
                              ...
                              <input class=" p-3 w-full text-sm text-black bg-gray-50 rounded-l-10xl  " placeholder="Info@yourgmail.com" type="email" id="email">
                          </div>
                          <a href="/">
                              <button type="button" class="w-12 text-base rounded-r-10xl bg-mauve p-3 ">
