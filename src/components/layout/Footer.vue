...
<template>
<footer class="p-4 bg-gradient-to-r from-purple-900 to-fond site sm:p-6 bottom-0">
  <div class="md:flex md:justify-between">
      <div class="mx-20 mt-6">
          <RouterLink to="/" class="">
              <img src="/logo/logo-ref-standart.svg" class=" h-8 mb-3" alt="Logo Noffta" />
              <p class="text-white text-center">An other way to leave a footstep in the OFFF.</p>
          </RouterLink>
      </div>
